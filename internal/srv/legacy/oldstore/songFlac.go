...
func (s *OldStore) createSongNewFromFlacContent(externalTrn storm.Node, content []byte, lastAlbumId restApiV1.AlbumId) (*restApiV1.SongNew, error) {
...
func (s *OldStore) updateSongContentFlacTag(externalTrn storm.Node, songEntity *oldentity.SongEntity) error {
