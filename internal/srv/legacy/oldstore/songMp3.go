...
func (s *OldStore) createSongNewFromMp3Content(externalTrn storm.Node, content []byte, lastAlbumId restApiV1.AlbumId) (*restApiV1.SongNew, error) {
...
func (s *OldStore) updateSongContentMp3Tag(externalTrn storm.Node, songEntity *oldentity.SongEntity) error {
	// Extract song meta from tags
