...
func (s *OldStore) CreateFavoritePlaylist(externalTrn storm.Node, favoritePlaylistMeta *restApiV1.FavoritePlaylistMeta, check bool) (*restApiV1.FavoritePlaylist, error) {
	var e error
	...
	if e == storm.ErrNotFound {
		...
		favoritePlaylistEntity = oldentity.FavoritePlaylistEntity{
			UpdateTs: now,
		}
		...
		var deletedFavoritePlaylistEntity oldentity.DeletedFavoritePlaylistEntity
...
func (s *OldStore) DeleteFavoritePlaylist(externalTrn storm.Node, favoritePlaylistId restApiV1.FavoritePlaylistId) (*restApiV1.FavoritePlaylist, error) {
	var e error
	...
	e = txn.Save(oldentity.NewDeletedFavoritePlaylistEntity(favoritePlaylistId))
	if e != nil {
		return nil, e
	}
...
func (s *OldStore) GetDeletedFavoritePlaylistIds(externalTrn storm.Node, fromTs int64) ([]restApiV1.FavoritePlaylistId, error) {
	var e error

	favoritePlaylistIds := []restApiV1.FavoritePlaylistId{}
	deletedFavoritePlaylistEntities := []oldentity.DeletedFavoritePlaylistEntity{}
...
func (s *OldStore) GetDeletedUserFavoritePlaylistIds(externalTrn storm.Node, fromTs int64, userId restApiV1.UserId) ([]restApiV1.PlaylistId, error) {
	var e error
