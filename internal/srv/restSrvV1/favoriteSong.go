...
func (s *RestServer) readFavoriteSongs(w http.ResponseWriter, r *http.Request) {
	...
	favoriteSongs, err := s.service.ReadFavoriteSongs(nil, &restApiV1.FavoriteSongFilter{})
	if err != nil {
...
func (s *RestServer) createFavoriteSong(w http.ResponseWriter, r *http.Request) {
	...
	favoriteSong, err := s.service.CreateFavoriteSong(nil, &favoriteSongMeta, true)
	if err != nil {
...
func (s *RestServer) deleteFavoriteSong(w http.ResponseWriter, r *http.Request) {
	...
	favoriteSong, err := s.service.DeleteFavoriteSong(nil, favoriteSongId)
	if err != nil {
