...
func (s *RestServer) readFavoritePlaylists(w http.ResponseWriter, r *http.Request) {
	...
	favoritePlaylists, err := s.oldStore.ReadFavoritePlaylists(nil, &restApiV1.FavoritePlaylistFilter{})
	if err != nil {
...
func (s *RestServer) createFavoritePlaylist(w http.ResponseWriter, r *http.Request) {
	...
	favoritePlaylist, err := s.oldStore.CreateFavoritePlaylist(nil, &favoritePlaylistMeta, true)
	if err != nil {
...
func (s *RestServer) deleteFavoritePlaylist(w http.ResponseWriter, r *http.Request) {
	...
	favoritePlaylist, err := s.oldStore.DeleteFavoritePlaylist(nil, favoritePlaylistId)
	if err != nil {
