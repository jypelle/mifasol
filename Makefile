...
release:
	...
	GOOS=windows GOARCH=amd64 go build -o internal/srv/webSrv/static/clients/mifasolcli-windows-amd64.exe ./cmd/mifasolcli; \
	echo "Build linux amd64 client"; \
	GOOS=linux GOARCH=amd64 go build -o internal/srv/webSrv/static/clients/mifasolcli-linux-amd64 ./cmd/mifasolcli; \
	echo "Build linux arm client"; \
	GOOS=linux GOARCH=arm GOARM=7 go build -o internal/srv/webSrv/static/clients/mifasolcli-linux-arm ./cmd/mifasolcli; \
#	echo "Build darwin amd64 client"; \
#	GOOS=darwin GOARCH=amd64 go build -o release/mifasolcli-darwin-amd64 ./cmd/mifasolcli; \
