...
#	echo "Build windows arm64 client"; \
#	GOOS=windows GOARCH=arm64 go build -o internal/srv/webSrv/clients/mifasolcli-windows-arm64.exe ./cmd/mifasolcli; \
...
#	echo "Build windows arm64 server"; \
#	GOOS=windows GOARCH=arm64 go build -o release/mifasolsrv-windows-arm64.exe ./cmd/mifasolsrv; \
